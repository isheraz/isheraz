      ...
      <div className="shell">
        ...
        <div className="about-grid">
          <div>
            ...
            <p style={{ marginTop: 28 }}>Want to talk? <a href="mailto:sherazahmed93@gmail.com" style={{ color: 'var(--accent)', borderBottom: '1px solid' }}>sherazahmed93@gmail.com</a> · <a href="https://github.com/isheraz" target="_blank" rel="noreferrer" style={{ color: 'var(--accent)', borderBottom: '1px solid' }}>@isheraz</a></p>
          </div>
